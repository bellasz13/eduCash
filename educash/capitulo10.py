...
def Capitulo10Page(page: ft.Page):
    ...
    def criar_quiz():
        perguntas = [
            {
                "pergunta": "Qual é o principal benefício trazido pela tecnologia de blockchain para o mercado de criptoativos?",
                "alternativas": [
                    {"texto": "Diminuição das taxas de transação", "correta": False},
                    {"texto": "Garantia de segurança nas transações por meio de criptografia", "correta": True},
                    {"texto": "Redução da volatilidade dos ativos", "correta": False},
                    {"texto": "Criação de moedas digitais nacionais controladas por bancos centrais", "correta": False},
                ],
            },
            {
                "pergunta": "Sobre as criptomoedas, assinale a alternativa correta:",
                "alternativas": [
                    {"texto": "Bitcoin é o único criptoativo que não depende de um sistema bancário", "correta": False},
                    {"texto": "Ethereum é apenas uma moeda digital, assim como o Bitcoin", "correta": False},
                    {"texto": "Stablecoins têm como referência algum valor fiduciário, como o dólar ou o ouro", "correta": True},
                    {"texto": "NFTs são fungíveis e podem ser trocados por outros tokens de mesmo valor e características", "correta": False},
                ],
            },
                {
                "pergunta": "Qual é o principal objetivo do IPCA no Brasil?",
                "alternativas": [
                    {"texto": "Medir a variação de preços de produtos e serviços consumidos por famílias de alta renda", "correta": False},
                    {"texto": "Calcular a inflação considerando apenas os preços de bens agrícolas", "correta": False},
                    {"texto": "Medir a inflação de produtos e serviços consumidos por famílias com renda de 1 a 40 salários mínimos", "correta": True},
                    {"texto": "Monitorar o impacto da inflação apenas no setor de habitação", "correta": False},
                ],
            },
                {
                "pergunta": "Sobre o impacto da inflação, qual das alternativas abaixo está correta?",
                "alternativas": [
                    {"texto": "A inflação sempre gera benefícios para os consumidores, pois ela eleva os salários proporcionalmente ao aumento dos preços", "correta": False},
                    {"texto": "A inflação só afeta o custo de vida das famílias de baixa renda", "correta": False},
                    {"texto": "A inflação pode reduzir o poder de compra da moeda, mas não afeta o rendimento real dos investimentos", "correta": False},
                    {"texto": "O aumento da inflação pode diminuir o poder de compra e impactar a rentabilidade real dos investimentos", "correta": True},
                ],
            },
                {
                "pergunta": "Qual das alternativas a seguir descreve uma vantagem de começar a investir para a aposentadoria cedo?",
                "alternativas": [
                    {"texto": "Menor risco de volatilidade nos investimentos", "correta": False},
                    {"texto": "Maior acumulação de patrimônio devido aos juros compostos", "correta": True},
                    {"texto": "Menor necessidade de diversificação na carteira de investimentos", "correta": False},
                    {"texto": "Menos tempo necessário para adquirir conhecimento em investimentos", "correta": False},
                ],
            },
                {
                "pergunta": "Sobre os tipos de previdência privada no Brasil, qual a afirmativa correta?",
                "alternativas": [
                    {"texto": "O VGBL e o PGBL são planos de previdência que permitem apenas contribuições mensais fixas", "correta": False},
                    {"texto": "O PGBL é mais indicado para quem deseja reduzir o Imposto de Renda na declaração", "correta": True},
                    {"texto": "O VGBL permite que o participante defina apenas o valor do benefício a ser recebido mensalmente após a aposentadoria", "correta": False},
                    {"texto": "O PGBL oferece uma rentabilidade superior ao VGBL devido à sua estrutura fiscal", "correta": False},
                ],
            },
            {
                "pergunta": "Qual das opções a seguir é uma característica importante da reserva de emergência?",
                "alternativas": [
                    {"texto": "Deve ser usada como primeira opção em casos de imprevistos", "correta": False},
                    {"texto": "Pode ser investida em ativos de alto risco para obter maiores retornos", "correta": False},
                    {"texto": "Deve ser utilizada apenas para compras de longo prazo", "correta": False},
                    {"texto": "Deve ser deixada disponível e segura para situações inesperadas", "correta": True},
                ],
            },
                {
                "pergunta": "O que é recomendado ao identificar áreas no orçamento familiar que estão gastando demais?",
                "alternativas": [
                    {"texto": "Ignorar essas áreas e continuar com o orçamento atual", "correta": False},
                    {"texto": "Aumentar as despesas não essenciais para manter o equilíbrio financeiro", "correta": False},
                    {"texto": "Cortar ou reduzir despesas supérfluas sem comprometer a qualidade de vida", "correta": True},
                    {"texto": "Transferir recursos da reserva de emergência para cobrir esses custos", "correta": False},
                ],
            },
                {
                "pergunta": "Qual das opções a seguir é uma aplicação da Inteligência Artificial no setor financeiro?",
                "alternativas": [
                    {"texto": "Reduzir os custos de fabricação de produtos", "correta": False},
                    {"texto": "Automatizar as funções de recursos humanos nas empresas", "correta": False},
                    {"texto": "Aumentar a quantidade de recursos naturais disponíveis para as empresas", "correta": False},
                    {"texto": "Prever o comportamento dos mercados financeiros com base em dados passados", "correta": True},
                ],
            },
                {
                "pergunta": "Como a Inteligência Artificial pode ajudar na análise de risco em instituições financeiras?",
                "alternativas": [
                    {"texto": "Prevendo quais candidatos a empréstimo têm maior probabilidade de não pagar suas dívidas", "correta": True},
                    {"texto": "Criando previsões sobre o crescimento do mercado imobiliário", "correta": False},
                    {"texto": "Automatizando a produção de relatórios financeiros anuais", "correta": False},
                    {"texto": "Estabelecendo a rentabilidade de investimentos em produtos de consumo", "correta": False},
                ],
            },
        ]
...
Na essência, os tokens são fungíveis ou não fungíveis, os famosos NFTs (Non-Fungible Tokens). Os fungíveis podem ser substituídos por outros da mesma espécie, qualidade e quantidade. Já o conceito de não fungíveis é usado para ativos com características únicas, como uma obra de arte, por exemplo, ou benefícios exclusivos para torcedores de um determinado time de futebol, os chamados fan-tokens.
    ...
    def subcapitulo10_2():
        criar_subcapitulo(
            "Inflação e seus\nimpactos no seu\npoder de compra",
            """
Inflação é um termo da economia usado para designar o aumento generalizado de preços de bens e serviços. Com isso, a inflação representa o aumento do custo de vida e a consequente redução no poder de compra da moeda.            Esse aumento de preços não é necessariamente ruim ou prejudicial ao consumidor, principalmente quando é controlado, espaçado ao longo do tempo e vem acompanhado de reajustes nos salários-mínimos. Mas pode causar transtornos para consumidores – e para a economia de um país – quando aumenta em uma velocidade maior do que pode ser absorvida. 
...
Também pode ajudar na análise de riscos, monitorando as condições do mercado e avaliando a volatilidade no mercado, além de ajudar a gerir e a monitorar as carteiras de investimento, avaliando os resultados e gerando relatórios.Isso permite que os investidores tomem decisões de investimento mais informadas e de forma mais eficiente.
    ...
    def subcapitulo10_desafio():
        criar_subcapitulo(
            "Desafio",
            """
Parabéns por chegar até aqui, futuro estrategista financeiro! É hora de colocar em prática os conceitos que você aprendeu. Vamos explorar a interseção entre investimentos em criptoativos e a necessidade de um planejamento financeiro robusto.

Seu Desafio:

Criação de Estratégia em Criptomoedas:

Escolha uma criptomoeda (como Bitcoin, Ethereum ou uma stablecoin) e pesquise seus principais atributos, riscos e oportunidades.
Simule um investimento inicial de R$1.000. Use uma ferramenta ou calculadora de rentabilidade para projetar o retorno em diferentes cenários (alta, baixa e estabilidade de mercado).
Planejamento de Reserva de Emergência:

Antes de ampliar sua exposição ao mercado de criptoativos, defina um valor para a sua reserva de emergência. Esse valor deve ser suficiente para cobrir de 3 a 6 meses de despesas fixas.
Liste estratégias para manter sua reserva líquida e protegida de volatilidade.
Análise da Relação Inflação e Cripto:

Investigue como a inflação impacta o poder de compra e a relação com a valorização/desvalorização de ativos financeiros, incluindo criptomoedas.
Crie um gráfico comparativo entre a evolução do IPCA e o preço do Bitcoin nos últimos anos.
Reflexão Final:

Avalie: Após concluir este exercício, você acredita que os criptoativos têm espaço no seu planejamento financeiro? Quais seriam os próximos passos para integrar esse investimento de forma segura e inteligente?
Lembre-se: A diversificação e o planejamento são pilares essenciais para o sucesso financeiro. Boa sorte!
